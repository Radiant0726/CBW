...
class SpeakerDatasetTIMIT_poison(Dataset):
    ...
    def __init__(self, shuffle=True, utter_start=0):
        ...
        self.path = hp.poison.poison_test_path
...
class SpeakerDatasetTIMITPreprocessed(Dataset):
    ...
    def __init__(self, path, phase="train", shuffle=True, utter_start=0):
        
        self.path = path
        self.utter_num = hp.train.M if phase=="train" else hp.test.M
        self.file_list = os.listdir(self.path)
        self.shuffle=shuffle
        self.utter_start = utter_start
